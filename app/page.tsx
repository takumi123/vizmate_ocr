    ...
    <main className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-cyan-50 flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-bold">Welcome to OCR Service</CardTitle>
          <CardDescription>
            Sign in with your Google account to start processing your documents
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Button
            ...
            onClick={() => {
              // Google OAuth login will be implemented here
